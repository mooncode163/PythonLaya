...
# remote: Permission to Jaykie/PythonCreator.git denied to helenmooncom.
def upload():
    ...
    os.system("git push -f https://mooncode163:Qianlizhiwai1@github.com/mooncode163/PythonCreator.git")
